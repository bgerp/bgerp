...
class acc_plg_ExpenseAllocation extends core_Plugin
{
	...
	public static function on_AfterPrepareEditForm($mvc, &$data)
	{
		...
		$form->FNC('expenseItemId', 'acc_type_Item(select=titleNum,allowEmpty,lists=600,showAll)', "input1=none,after={$mvc->expenseItemAfterField},caption=Отнасяне (и разпределяне) на разходи->Разход за,removeAndRefreshForm=allocationBy");
