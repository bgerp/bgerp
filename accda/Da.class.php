...
class accda_Da extends core_Master
{
    ...
    {
        $this->FLD('productId', 'key2(mvc=cat_Products,select=name,selectSourceArr=cat_Products::getProductOptions,allowEmpty,hasProperties=fixedAsset)', 'caption=Счетоводство->Артикул,mandatory,silent,refreshForm,remember');
