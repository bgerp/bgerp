 ...
 * Валутите
 */
class bank_Currencies extends core_Manager {
    
    /**
     * Интерфейси, поддържани от този мениджър
     */
    var $interfaces = 'acc_RegisterIntf, bank_CurrenciesAccRegIntf';

    /**
     *  @todo Чака за документация...
     */
    var $loadList = 'plg_Created, plg_RowTools, bank_Wrapper, acc_plg_Registry,
                     CurrencyGroups=bank_CurrencyGroups,  plg_Sorting, plg_State2';
    ...
    function description()
    {
        ...
        $this->FLD('groups', 'keylist(mvc=bank_CurrencyGroups, select=name)', 'caption=Групи');
