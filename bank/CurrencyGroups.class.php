 ...
 */
class bank_CurrencyGroups extends core_Manager
{
    /**
     *  @todo Чака за документация...
     */
    var $loadList = 'plg_Created, plg_RowTools, Currencies=bank_Currencies, bank_Wrapper';
    ...
    {
    	$row->name = Ht::createLink($row->name, array('bank_Currencies', 'list', 'groupId' => $rec->id));
    }
