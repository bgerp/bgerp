 ...
 * @since      v 0.1
 */
class bank_CurrencyRates extends core_Manager
{
    /**
     *  @todo Чака за документация...
     */
    var $loadList = 'plg_Created, plg_RowTools, Currencies=bank_Currencies, bank_Wrapper, plg_Sorting, plg_Chart';
    ...
    {
        $this->FLD('currencyId', 'key(mvc=bank_Currencies, select=code)', 'caption=Валутa,chart=diff');
        $this->FLD('baseCurrencyId', 'key(mvc=bank_Currencies, select=code)', 'caption=Към основна валута');
    ...
    {
        return new Redirect (array('bank_CurrencyRates', 'default'), $this->retrieveCurrenciesFromEcb());
    }
    ...
    function on_AfterSetupMvc($mvc, &$res)
    {
        ...
        $rec->controller = "bank_CurrencyRates";
