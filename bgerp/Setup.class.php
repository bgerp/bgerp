...
/**
 * Опции над колко да се показват като радио бутони във вертикалните форми
 */
defIfNot('BGERP_VERTICAL_FORM_DEFAULT_MAX_RADIO', 4);
...
class bgerp_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        'BGERP_VERTICAL_FORM_DEFAULT_MAX_RADIO' => array('int(min=1)', 'caption=Опции над колко да се показват като радио бутони във вертикалните форми->Избор'),
