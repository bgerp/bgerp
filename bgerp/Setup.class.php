...
class bgerp_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        'BGERP_VERTICAL_FORM_DEFAULT_MAX_RADIO_LENGTH' => array('int(min=1)', 'caption=Максимална обща дължина на опциите за да се показват като радиобутони->Брой символи, "unit= |(в това число 3 символа за бутона на всяка опция)|*", customizeBy=user'),
