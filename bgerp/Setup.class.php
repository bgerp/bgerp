...
class bgerp_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        'BGERP_VERTICAL_FORM_DEFAULT_MAX_RADIO_LENGTH' => array('int(min=1)', 'caption=Колко символа максимална дължина опции да се показват като радио бутони->Брой символи, customizeBy=user'),
