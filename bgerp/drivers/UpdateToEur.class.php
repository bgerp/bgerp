...
class bgerp_drivers_UpdateToEur extends core_BaseClass
{
    ...
    public function render($data)
    {
        ...
        $data->tpl = new ET('
                                ...
                                <div class="legend">Подготовка към EUR</div>Системата ви е подготвена за преминаване към евро, но са необходими допълнителни миграции. 
                                    Моля, свържете се с ' . $eLink . '.
                                </div>
                              ');
