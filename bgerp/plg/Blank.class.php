...
class bgerp_plg_Blank extends core_Plugin
{
    ...
    public static function getCompanyLogoUrl()
    {
        ...
        if ($companyLogo && (FILEMAN_HANDLER_LEN == strlen($companyLogo)) && ($filemanInst->fetchByFh($companyLogo))) {
            $sourceType = 'fileman';
        } else {
            ...
            if (!defined('EF_PRIVATE_PATH') || (0 !== strpos($companyLogo, EF_PRIVATE_PATH))) {
        ...
        $isAbsolute = (bool) Mode::is('text', 'xhtml');
