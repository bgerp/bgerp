...
class bglocal_Address extends core_MVC
{
    public static $places = array(
        ...
        'gorna oriahovitsa' => 'Горна Оряховица',
     ...
     * Извличаме контакти
     */
    public function extractContact($text)
    {
     ...
     */
    public function extractContactData($line, $id, &$res)
    {
        // Зареждаме необходимите масиви
        static $regards, $companyTypes, $companyWords, $givenNames;
     ...
     * Извличаме данни
     */
    public function extractContactData1($text, $email = null, $country = null)
    {
    }
}
