...
class budget_IncomeExpenses extends core_Manager
{
     ...
     * Заглавие
     */
    public $title = 'Приходи и Разходи';
    
    
    /**
     * Заглавие в единствено число
     */
    public $singleTitle = 'Приход/разход';
     ...
     */
    public $listFields = 'number, period, project, type, sume, currency, rate, company, person, state, location, department, activity';
