...
class cal_Calendar extends core_Master
{
    ...
    protected static function on_AfterPrepareListFilter($mvc, $data)
    {
        ...
        $data->listFilter->FNC('types', 'varchar(32)', 'caption=Тип,placeholder=Всички,autoFilter,silent');
     ...
     */
    public static function recToVerbal(&$rec, $fields = '*')
    {
    ...
    public static function getDayStatus($date, $country = 'bg')
    {
    	...
    	if ($type == 'BG') {
            $query->where("#time = '{$time}' AND #type IN ('holiday', 'non-working', 'workday')");
    	} else {
