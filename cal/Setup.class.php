...
/**
 * Типове събития, които да се поакзват в календара
 */
...
class cal_Setup extends core_ProtoSetup
{
    ...
    var $configDescription = array(
            ...
            'CAL_SHOW_HOLIDAY_TYPE' => array('set', 'caption=Типове събития|*&#44; |*които да се поакзват в календара->Избор, customizeBy=powerUser, optionsFunc=cal_Setup::getHolidayTypeOptions'),
    );
