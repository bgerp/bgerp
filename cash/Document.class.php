...
abstract class cash_Document extends deals_PaymentDocument
{
    ...
    protected function getFields(core_Mvc &$mvc)
    {
        ...
        $mvc->FLD('amountDeal', 'double(decimals=2,max=2000000000,min=0,maxDecimals=2)', 'caption=Платени,mandatory,silent');
        ...
        $mvc->FLD('amount', 'double(decimals=2,max=2000000000,min=0,maxDecimals=2)', 'caption=Валута (и сума) на плащането->Сума,summary=amount,input=hidden');
