...
class cat_ProductTplCache extends core_Master
{
    ...
    {
        $data->listFilter->FLD('docId', 'key2(mvc=cat_Products,select=name,selectSourceArr=cat_Products::getProductOptions,allowEmpty,maxSuggestions=100,forceAjax)', 'input,caption=Артикул,placeholder=Всички,removeAndRefreshForm');
