...
class cat_products_Relations extends core_Manager
{
    ...
    public static function on_AfterPrepareListFilter($mvc, &$data)
    {
        ...
        $data->listFilter->FNC("productId", 'key2(mvc=cat_Products,select=name,selectSourceArr=cat_Products::getProductOptions,maxSuggestions=100,allowEmpty)', 'caption=Артикул,placeholderType=all');
        $data->listFilter->setField('relTypeId', 'placeholderType=all');
