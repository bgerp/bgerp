...
class cms_Articles extends core_Master
{
    ...
    public function act_Article()
    {
        ...
        if($prevLink || $nextLink) {
            $content->append("<table class='nav_item' style='margin-top:10px;margin-bottom:7px;' width=100%><tr><td align=left>{$prevLink}</td><td> </td><td align=right>{$nextLink}</td></tr></table>");
        }
