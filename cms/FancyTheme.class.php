...
class cms_FancyTheme extends core_ProtoInner
{
    ...
    public function prepareWrapper($tpl)
    {
        ...
        $css .= "\n    button, .vertical form[method=post] input[type=submit], form[method=post] .formTable input[type=submit] {background-color:#{$baseColor} !important; border: 1px solid #{$bordercolor} !important}";
