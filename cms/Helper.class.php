...
class cms_Helper extends core_BaseClass
{
	...
	public static function getUserFromSameBrid()
	{
		...
		if(empty($valsArr['email'])) return NULL;
	...
	public static function getErrorIfThereIsUserWithEmail($email)
	{
		...
		if(core_Users::getUserByEmail($email)) return "Изглежда, че има регистриран потребител с този имейл. Моля преди да продължите да се логнете|*.";
	}
}