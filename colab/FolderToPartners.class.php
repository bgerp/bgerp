...
{   
    ...
    */
    ...
    private function sendRegistrationEmail($rec)
    {
    	...
    	$url = core_Forwards::getUrl($this, 'Createnewcontractor', array('companyId' => (int)$rec->companyId, 'email' => $userEmail, 'rand' => str::getRand(), 'userNames' => $rec->names), 604800);
    ...
    function act_Createnewcontractor()
    {
    	...
    	if ($form->isSubmitted()) {
    		...
    		core_Forwards::deleteUrl($this, 'Createnewcontractor', array('companyId' => (int)$companyId, 'email' => $email, 'rand' => $rand, 'userNames' => $rec->names), 604800);
