...
{   
    ...
    */
    ...
    function act_Createnewcontractor()
    {
    	...
    	if($form->isSubmitted()){
    	    $fNicksArr = arr::make($this->forbiddenNicks, TRUE);
    	    $nick = trim(mb_strtolower($form->rec->nick));
    	    if ($nick && $fNicksArr[$nick]) {
