...
class color_Object
{
    ...
    /**
     * Съобщение за грешка, ако стойността не може да се разпознае като цвят
     */
    public $error;
     ...
     */
    public function __construct($value, $g = null, $b = null)
    {
        $this->value = $value;
     ...
     * @todo Чака за документация...
     */
    public function randInit($min = 0, $max = 255)
    {
        $this->r = rand(0, 255);
        $this->g = rand(0, 255);
        $this->b = rand(0, 255);
     ...
     * @todo Чака за документация...
     */
    public function resize($rate, $add = 0)
    {
