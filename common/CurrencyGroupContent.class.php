 ...
 */
class common_CurrencyGroupContent extends core_Manager
{
    /**
     *  @todo Чака за документация...
     */
    var $loadList = 'plg_Created, plg_RowTools, common_Wrapper, CurrencyGroups=common_CurrencyGroups';
    ...
    {
        $this->FLD('groupId', 'key(mvc=common_CurrencyGroups, select=name)', 'caption=Група, input=hidden');
        $this->FLD('currencyName', 'key(mvc=common_Currencies, select=name)', 'caption=Валути');
