 ...
 * @since      v 0.1
 */
class common_CurrencyRates extends core_Manager
{
    /**
     *  @todo Чака за документация...
     */
    var $loadList = 'plg_Created, plg_RowTools, Currencies=common_Currencies, common_Wrapper, plg_Sorting, plg_Chart';
    ...
    {
        $this->FLD('currencyId', 'key(mvc=common_Currencies, select=code)', 'caption=Валутa,chart=diff');
        $this->FLD('baseCurrencyId', 'key(mvc=common_Currencies, select=code)', 'caption=Към основна валута');
    ...
    {
        return new Redirect (array('common_CurrencyRates', 'default'), $this->retrieveCurrenciesFromEcb());
    }
    ...
    function on_AfterSetupMvc($mvc, &$res)
    {
        ...
        $rec->controller = "common_CurrencyRates";
        ...
        $res .= "<li>На Cron са зададени update_currencies_afternoon и update_currencies_night</li>";
    }
