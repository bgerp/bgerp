...
class cond_Ranges extends core_Manager
{
    ...
    public function description()
    {
        ...
        $this->FLD('min', 'bigint(min=0)', 'mandatory,caption=От №, unit= включително (долна граница)');
        $this->FLD('max', 'bigint(Min=0)', 'mandatory,caption=До №, unit= включително (горна граница)');
