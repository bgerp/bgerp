...
class crm_Companies extends core_Master
{
     ...
     */
    public $searchFields = 'name,pCode,place,country,folderName,email,tel,fax,website,vatId,info,uicId,id,eori,address,nkid';
     ...
     */
    public $balanceRefAccounts = '1511,1512,1513,1514,1521,1522,1523,1524,153,159,323,3231,3232,401,402,403,404,405,406,409,411,412,413,414,415,419';
