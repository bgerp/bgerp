   ...
   <div class="folder-cover">
      ...
      <fieldset class="detail-info">
		...
		<div>[#address#]</div>
            <!--ET_END address-->
            <!--ET_BEGIN mobile-->
		<div>|Моб.|*: <b>[#mobile#]</b></div>
            <!--ET_END mobile-->
            <!--ET_BEGIN tel-->
		<div>|Тел.|*: <b>[#tel#]</b></div>
            <!--ET_END tel-->
            <!--ET_BEGIN fax-->
		<div>|Факс|*: <b>[#fax#]</b></div>
            <!--ET_END fax--> 
            <!--ET_BEGIN email-->
		<div>|E-мейл|*: <b>[#email#]</b></div>
            <!--ET_END email--> 
            <!--ET_BEGIN website-->
		<div>|Сайт/Блог|*: <b>[#website#]</b></div>
            <!--ET_END website-->
         </div>
      </fieldset>
      <!--ET_END contacts-->
      ...
      <!--ET_BEGIN business-->
		 ...
		 <div class="groupList">
		    <!--ET_BEGIN buzCompanyId-->
		    <div><b>[#buzCompanyId#]</b></div>
		    <!--ET_END buzCompanyId-->
		    <!--ET_BEGIN buzTel-->
		    <div>|Тел.|*:&nbsp;<b>[#buzTel#]</b></div>
		    <!--ET_END buzTel-->
		    <!--ET_BEGIN buzFax-->
		    <div>|Факс|*:&nbsp;<b>[#buzFax#]</b></div>
		    <!--ET_END buzFax--> 
		    <!--ET_BEGIN buzEmail-->
		    <div>|E-мейл|*:&nbsp;<b>[#buzEmail#]</b></div>
		    <!--ET_END buzEmail--> 
		    <!--ET_BEGIN buzAddress-->
		    <div>|Адрес|*:&nbsp;<b>[#buzAddress#]</b></div>
		    <!--ET_END buzAddress--> 
		 </div>
	      </fieldset>
      <!--ET_END business-->
      <!--ET_BEGIN idCard-->
		 ...
		 <!--ET_BEGIN idCardIssuedBy-->
		 <div><b>[#idCardIssuedBy#]</b></div>
		 <!--ET_END idCardIssuedBy--> 
	      </fieldset>
      <!--ET_END idCard-->
      <!--ET_BEGIN info-->
	      <fieldset class="detail-info">
