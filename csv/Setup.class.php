...
/**
 * Брой на десетичничните цифри при експорт в csv
 */
defIfNot('CSV_DECIMALS', 2);
...
class csv_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        'CSV_DECIMALS' => array('int(min=0,max=12)', 'caption=Формат за експорт на CSV->Точност, customizeBy=powerUser'),
