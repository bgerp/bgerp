...
class currency_CurrencyRates extends core_Detail
{
     ...
     */
    public $listFields = 'currencyId, date, rate, baseCurrencyId';
    
    
    /**
     * Заглавие
     */
    public $title = 'Исторически валутни курсове';
     ...
     */
    public $canRetrieve = 'currency,ceo';
     ...
     * @return string
     */
    public function retrieveCurrenciesFromEcb()
    {
     ...
     */
    public function cron_RetrieveCurrencies()
    {
    ...
    public static function on_AfterPrepareListFilter($mvc, &$data)
    {
        ...
        $data->listFilter->FNC('currencySearch', 'key(mvc=currency_Currencies, select=code, allowEmpty, where=#code !\\= \\\'EUR\\\')', 'caption=Валута,placeholderType=all,autoFilter,input=input');
