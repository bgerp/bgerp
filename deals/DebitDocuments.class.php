...
class deals_DebitDocuments extends core_Master
{
    ...
    public static function getTransaction($id)
    {
    	...
    	$dealFrom = array('1' => array($dealRec->contragentClassId, $dealRec->contragentId),
    	...
    	$dealTo = array('1' => array($rec->contragentClassId, $rec->contragentId),
    	...
    	$result = (object)array(
    			...
    			'entries' => array(
    					array('amount' => $amount, 'debit' => $debitArr, 'credit' => $creditArr,)
    		)
    	);
