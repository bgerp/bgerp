...
abstract class deals_Document extends deals_PaymentDocument
{
    ...
    protected static function addDocumentFields(core_Mvc $mvc)
    {
        ...
        $mvc->FLD('amount', 'double(decimals=2,maxDecimals=2)', 'caption=Платени,mandatory,summary=amount');
        ...
        $mvc->FLD('amountDeal', 'double(decimals=2,maxDecimals=2)', 'caption=Насрещна сделка->Заверени,mandatory,input=none');
