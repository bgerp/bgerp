...
class doc_LinkedTemplates extends core_Master
{
    ...
    public function description()
    {
        ...
        $this->FLD('formFolder', 'key2(forceAjax, mvc=doc_Folders,forceReplica, titleFld=title, maxSuggestions=100, selectSourceArr=doc_Linked::prepareFoldersForDoc, allowEmpty, showWithDocs)', 'caption=Настройки на формата->Папка, class=w100');
