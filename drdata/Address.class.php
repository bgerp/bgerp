...
{
    public static $regards;
    public static $companyTypes;
    public static $companyWords;
    public static $givenNames;
     ...
     */
    public static function extractTelNumbers($line, $negativeList = array())
    {
     ...
     */
    public static function extractFaxNumbers($line)
    {
    ...
    public static function rateGreeting($obj)
    {
     ...
     */
    public static function renderTable($arr)
    {
