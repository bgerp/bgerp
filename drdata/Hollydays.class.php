...
* DOWNLOAD.BG
*
* Клас за мениджиране на празниците и поздравите.
*
* @copyright (C) 2005 by Experta LTD
...
class drdata_Holidays extends core_Manager
{
    ...
    function description()
    {
        ...
        $this->FLD('base', 'enum(1=Януари,
         ...
         $this->FLD('holidayType', 'enum(bulgarian,women,nameday,muslim,foreign)', 'caption=Празник->Тип');
         $this->FLD('holidayData', 'test', 'caption=Празник->Данни');

    }


    /**
     * Въща датата на ортодоксалния Великден за указаната година
     */
	...
	function on_AfterSetupMvc($mvc, $res)
    {
       ...
       "01|01|Нова година|Честита Нова [#year#] Година, [#name#]!
        01|02||Много Здраве, Щастие и Успехи през [#year#] година, [#name#]!
        ...
        12|26|Коледа|Честита Коледа, [#name#]!  
        ...
        if($addedNew) {
            $res = "<li style='color:green;'>Добавени {$addedNew} празника</li>";
        } 
	...
	function Holiday() {
		...
		$this->fixedNamedays = array(
			'01-01' => "vasil,vasilka,veselin,veselina,vesela,vesel,vesela,veselin,veselina,veselka,vesi,veska,vesko,veso,vessela,vesselin,vesselina,vesso,vessy,vesy,vasi,vasia,vasil,vasilena,vasilka,vaska,vasko,vaso,vassil,vasya",
			...
			'21-01' => "agnesa,agnes,maskim,max,maxi,maxim,valera,valeri,valeria,valeriq,valeriy,valeriya,valery",
			...
			'14-02' => "valenti,valentin,valentina,valentino",
			...
			'06-05' => "georgi,gergana,ginka,galia,gancho,galin,galina,genko,genoveva,gergin,gergina,giuro,zhordz,zhoro,joro",
			'09-05' => "hristofor,christofor",
			'11-05' => "kiril,metodi,metodii,metody",
			'17-05' => "alexii,alexy",
			'21-05' => "konstantin,koicho,koycho,kosta,kostadin,kostadina,dinka,dinko,elena,eli,elin,elka,ilona,kuncho,lenko,stamen,stoil,stoyan,stoian,stoyanka,traiko",
			'26-05' => "karp,karpo",
		...
		$this->movableNamedays = array (
			...
			'63' => "asen,asparyh,krym,asparuh,krum,panayot,panaiot,rumen,rumiana,rymen,rymiana,chavdar,kubrat,kybrat",
			'7' => "toma",
			'-8' => "lazar,lazarka,lacho,lazo",
			'-7' => "aglika,aglyka,bozhura,grozdan,grozdanka,dalia,dalya,deliya,delia,zhasmin,zhasmina,zyumbyul,ziumbulka,iva,lora,malina,kalina,lili,lila,lilia,lora,liuliana,magnolia,petunia,ruzha,reneta,kitka,fidan,fidanka,tsvetoslav,jagoda,jasmina,karamfil,karamfilka,ventsislav,ventsislava,violeta,varban,girgin,delian,deliana,dilian,diliana,deian,zdravko,zdravka,latinka,liliana,margarita,nevena,ralitsa,roza,rosen,rositsa,trendafil,tsveta,tsvetan,tsvetanka,tsviatko,tseno,tsonko,javor,iavor,iasen,jasen",
			'-43' => "todor,teodor,todora,teodora,totio,totjo,totyo,bozhil,bojil,bozhidar,bojidar,bojidara,bojan,bozhan,bozhidar,bozhidara,bozhko,bojko",
