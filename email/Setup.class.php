...
class email_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        // Максимален брой автоматични отговори към един имейл за зададения период
        'EMAIL_AUTOMATIC_RESPONSE_MAX_COUNT' => array('int(min=1,max=100)', 'mandatory, caption=Автоматични отговори към един имейл->Максимален брой'),

        // Период за ограничаване на автоматичните отговори към един имейл
        'EMAIL_AUTOMATIC_RESPONSE_PERIOD' => array('time(min=60,suggestions=1 час|6 часа|12 часа|24 часа|2 дни|1 седмица)', 'mandatory, caption=Автоматични отговори към един имейл->Период'),
