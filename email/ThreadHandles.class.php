...
class  email_ThreadHandles extends core_Manager
{
     ...
     * Зареждаме плъгините
     */
    var $loadList = "email_Wrapper,plg_RowTools";

    
    /**
     * Наименование на мениджъра
     */
    var $title = "Манипулатори на нишки";
     ...
     * @return string
     */
    static function stripSubject($subject, $threadId)
    {
        if($threadId) {
     ...
     */
    static function getHandleByThreadId($threadId)
    {
     ...
     */
    static function getThreadIdByHandle($handle)
    {
     ...
     */
    static function extractThreadFromSubject($subject)
    {
        $handles = array();
     ...
     */
    static function createThreadHandle_Type0($threadId)
    {
        $handle = "<{$threadId}>";
     ...
     * манипулатори на нишка.
     */
    static function extractThreadHandles_Type0($str)
    {
        $handles = array();
     ...
     */
    static function createThreadHandle_Type1($threadId)
    {
     ...
     * манипулатори на нишка.
     */
    static function extractThreadHandles_Type1($str)
    {
        $handles = array();
     ...
     */
    static function createThreadHandle_Type2($threadId)
    {        
     ...
     * манипулатори на нишка.
     */
    static function extractThreadHandles_Type2($str)
    {
        $handles = array();
     ...
     */
    static function createThreadHandle_Type3($threadId)
    {
        do {
     ...
     * манипулатори на нишка.
     */
    static function extractThreadHandles_Type3($str)
    {
        $handles = array();
