...
/**
 * Начини на доставка в онлайн магазина
 *
 *
 * @category  bgerp
 * @package   eshop
 ...
 * @since     v 0.11
 */
class eshop_DeliveryTerms extends embed_Manager {
    
	
	/**
	 * Заглавие
	 */
	public $title = "Начини на доставка в онлайн магазина";
	
	
	/**
	 * Свойство, което указва интерфейса на вътрешните обекти
	 */
	public $driverInterface = 'eshop_DeliveryIntf';
	...
	public static function on_AfterGetRequiredRoles($mvc, &$requiredRoles, $action, $rec = NULL, $userId = NULL)
	{
		if(($action == 'changestate' || $action == 'delete') && isset($rec)){
			if(eshop_Settings::fetch("#terms LIKE '%|{$rec->id}|%'")){
	...
	{
		$file = "eshop/csv/DeliveryTerms.csv";
