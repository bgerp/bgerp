...
class eshop_Groups extends core_Master
{
    ...
    public function description()
    {
        ...
        $this->FLD('icon', 'fileman_FileType(bucket=eshopImages)', "caption=Картинка->Малка,unit=задължително пейзаж с поне 600px ширина");
        $this->FLD('image', 'fileman_FileType(bucket=eshopImages)', "caption=Картинка->Голяма,unit=препоръчително пейзаж с поне 1200px широчина");
