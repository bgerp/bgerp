...
class eshop_Settings extends core_Manager
{
    ...
    public function description()
    {
        ...
        $this->FLD('storeId', 'key(mvc=store_Stores,select=name,allowEmpty)', 'caption=Свързване със склад->Наличност/изписване от,unit= или');
        $this->FLD('locationId', 'key(mvc=crm_Locations,select=title,allowEmpty)', 'caption=Свързване със склад->адрес за EXW доставки,optionsFunc=crm_Locations::getOwnLocations');
