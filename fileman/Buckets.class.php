...
class fileman_Buckets extends core_Manager
{
     ...
     */
    public static function fetchByName($bucketName, $part = 'id')
    {
     ...
     */
    public function getAddFileInfo($bucketId)
    {
     ...
     */
    public function getInfoAfterAddingFile($fh)
    {
     ...
     */
    public static function getAllowedExtensionArr($extensions)
    {
