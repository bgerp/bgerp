    ...
    public static function getTabs($fRec)
    {
        ...
        if (trim($textPart)) {
            ...
            $tabsArr['text'] = (object)
                array(
                    'title' => 'Текст',
                    'html' => "<div class='webdrvTabBody' style='white-space:pre-line;'><div class='webdrvFieldset'>{$textPart}</div></div>",
                    'order' => 4,
                );
        }
        ...
        if ($filesStr) {
            ...
            $tabsArr['files'] = (object)
                array(
                    'title' => 'Файлове',
                    'html' => "<div class='webdrvTabBody' style='white-space:pre-line;'><div class='webdrvFieldset'>{$filesStr}</div></div>",
                    'order' => 5,
                );
        }
        ...
        $tabsArr['headers'] = (object)
            array(
                'title' => 'Хедъри',
                'html' => "<div class='webdrvTabBody'><div class='webdrvFieldset'>{$headersStr}</div></div>",
                'order' => 8,
            );
        ...
        $tabsArr['source'] = (object)
            array(
                'title' => 'Сорс',
                'html' => "<div class='webdrvTabBody'><div class='webdrvFieldset'>{$sourceShow}</div></div>",
                'order' => 9,
            );
        ...
        if (openai_Setup::get('TOKEN')) {
            ...
            array(
                'title' => 'Данни',
                'html' => "<div class='webdrvTabBody'><div class='webdrvFieldset'>{$parsedData}</div></div>",
                'order' => 100,
            );
        }
