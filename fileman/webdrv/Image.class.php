...
class fileman_webdrv_Image extends fileman_webdrv_Generic
{
    ...
    public static function getTabs($fRec)
    {
        ...
        if (self::canShowTab($fRec->fileHnd, 'text') || self::canShowTab($fRec->fileHnd, 'textOcr', true, true)) {
            ...
            $tabsArr['text']->html = "<div class='webdrvTabBody'><div class='webdrvFieldset'><iframe src='{$textPart}' frameBorder='0' ALLOWTRANSPARENCY='true' class='webdrvIframe'></div></iframe></div>";
