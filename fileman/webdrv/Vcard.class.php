...
class fileman_webdrv_Vcard extends fileman_webdrv_Generic
{
     ...
     */
    public static function getContent($fRec, $escape = true)
    {
     ...
     * @return string
     */
    public static function getPreview($fRec)
    {
     ...
     */
    public static function prepareData($fRec)
    {
     ...
     */
    public static function getSeparator($times = 100, $separator = '-')
    {
        // Създаме стринга
        $str = '';
