...
class fileman_webdrv_Webpage extends fileman_webdrv_Generic
{
    ...
    public static function getTabs($fRec)
    {
        ...
        if (trim($tPart)) {
            ...
            array(
                'title' => 'Текст',
                'html' => "<div class='webdrvTabBody'><div class='webdrvFieldset'>{$textPart}</div></div>",
                'order' => 4,
            );
        }
     ...
     */
    public static function getRichTextPart($fRec)
    {
     ...
     * return string - Текстовата част
     */
    public static function getTextPart($fRec)
    {
        if (is_object($fRec)) {
