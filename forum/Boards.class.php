...
class forum_Boards extends core_Master
{
     ...
     */
    public $listFields = 'title, category, shortDesc, themesCnt, commentsCnt, boardType, shared, lastComment, lastCommentedTheme, lastCommentBy, createdOn, createdBy';
    
    
    /**
     * Теми и коментари на дъската
     */
    public $details = 'forum_Postings';
    
    
    /**
     * Кой може да листва дъските
     */
    public $canRead = 'forum, cms, admin, ceo';
     ...
     */
    public $canWrite = 'forum, cms, admin,ceo';
     ...
     */
    public $singleLayoutFile = 'forum/tpl/SingleBoard.shtml';
     ...
     */
    public function prepareForum($data)
    {
     ...
     */
    public function prepareSearchForm($data)
    {
     ...
     */
    public function prepareBoards(&$category)
    {
        $query = $this->getQuery();
     ...
     */
    public function prepareBrowse_($data)
    {
