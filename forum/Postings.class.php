...
class forum_Postings extends core_Detail
{
     ...
     * нова нишка
     */
    public function renderBoardThemes_($data, $layout)
    {
     ...
     * Рендираме темата
     */
    public function renderTheme_($data)
    {
     ...
     */
    public function prepareTopicToolbar($data)
    {
        if ($this->haveRightFor('write', $data->rec)) {
     ...
     */
    public function renderTopic($data)
    {
     ...
     */
    public function prepareMove($data)
    {
    ...
    public static function on_AfterPrepareListFilter($mvc, $data)
    {
        ...
        $data->listFilter->FNC('board', 'key(mvc=forum_Boards,select=title,allowEmpty)', 'caption=Дъска,placeholder=Всички,input,silent');
