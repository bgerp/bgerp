...
class hr_CustomSchedules extends core_Master
{
    ...
    function description()
    {
        ...
        $this->FLD('departmenId', 'key(mvc=hr_Departments, select=name)', 'caption=Структура, width=50px');
        $this->FLD('personId', 'key(mvc=crm_Persons,select=name,group=employees)', 'caption=Служител,width=100%');
