...
class hr_EmployeeContracts extends core_Master
{
    ...
    public $loadList = 'plg_RowTools2, hr_Wrapper, doc_plg_Close,doc_ActivatePlg, bgerp_plg_Blank, plg_Printing, acc_plg_DocumentSummary,
                     ...
                     doc_plg_SelectFolder, doc_SharablePlg, bgerp_plg_Blank, hr_EmailCreatePlg';
    ...
    public static function colectPersonDaysType()
    {
        ...
        while ($rec = $query->fetch()) {
            ...
            $rec->stateAnswerSystem = $persons[$rec->personId]->stateAnswerSystem;
            ...
            crm_Profiles::save($rec, 'stateInfo,stateDateFrom,stateDateTo,stateAlternatePersons,stateAnswerSystem,stateEmoji');
        }
    }
