...
class hr_HomeOffice extends core_Master
{
    ...
    public function description()
    {
        ...
        $this->FLD('emoji', cls::get('type_Enum', array('options' => hr_Leaves::getEmojiesWithPrefix('h'))), 'caption=Информация->Икона за ника, maxRadio=4,columns=4,notNull,value=h2');
    ...
    {
        $data->listFilter->FLD('employeeId', 'key(mvc=crm_Persons,select=name,allowEmpty,group=employees)', 'caption=Служител,placeholder=Всички,silent,before=selectPeriod');
