...
{                  
	...
	protected function prepareRecs($rec, &$data = NULL)
	{
	    ...
	    while($recIndic = $query->fetch()){ 
	        $id = str_pad(core_Users::fetch($users[$recIndic->personId], 'names'), 120, " ", STR_PAD_LEFT) . "|". str_pad(hr_IndicatorNames::fetchField($recIndic->indicatorId,'name'), 120, " ", STR_PAD_LEFT);
