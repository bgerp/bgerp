...
/**
 * Мениджър на отчети работа от къщи и отсъствия
 *
 * @category  bgerp
 * @package   hr
 *
 ...
 *
 * @since     v 0.1
 * @title     Персонал » Работа от къщи и отсъствия
 */
class hr_reports_WorkFromHomeAndAbsence extends frame2_driver_TableData
{
    ...
    public function addFields(core_Fieldset &$fieldset)
    {
        ...
        $fieldset->FLD('employee', 'users(rolesForAll=ceo|repAllGlobal, rolesForTeams=ceo|manager|repAll|repAllGlobal)', 'caption=Служител,placeholder=Всички,after=type,single=none');
