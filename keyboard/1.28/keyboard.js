...
var VKI_attach, VKI_close;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_layout['Bulgarian Ph'] = [ // Bulgarian Phonetic Keyboard
      [["\u0447", "\u0427"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], [" <-", "Bksp"]],
     ...
     *
     */
    showKeyboard = this.VKI_show = function(elem, xClick) {
	  if(xClick) {
		elemPos = VKI_findPos(elem);
    ...
    this.VKI_close = VKI_close = function() {
      if (this.VKI_visible) {
        ...
        this.VKI_target.focus();
		if( self.VKI_target.onchange != null ) self.VKI_target.onchange();
        this.VKI_target = this.VKI_visible = false;
      }
    };
  };
