...
/* ********************************************************************
 **********************************************************************
 * HTML Virtual Keyboard Interface User Javascript - v1.36
          ...
          if (this.VKI_sizeAdj) {
            ...
            var kbsize = document.createElement('select');
              ...
              for (var x = 1; x <= 5; x++) {
                ...
                kbsize.addEventListener('change', function() {
...
#keyboardInputMasterUserScript.keyboardInputSize1 * { font-size:9px; }\
#keyboardInputMasterUserScript.keyboardInputSize3 * { font-size:13px; }\
#keyboardInputMasterUserScript.keyboardInputSize4 * { font-size:16px; }\
#keyboardInputMasterUserScript.keyboardInputSize5 * { font-size:20px; }\
\
...
#keyboardInputMasterUserScript thead tr th abbr {\
  font-size:1.3em;\
  font-weight:bold;\
...
#keyboardInputMasterUserScript thead tr td strong {\
...
#keyboardInputMasterUserScript thead tr td span:hover,\
#keyboardInputMasterUserScript thead tr td strong:hover {\
  background-color:#dddddd;\
}\
\
