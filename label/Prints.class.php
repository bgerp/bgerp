...
class label_Prints extends core_Master
{
     ...
     */
    public $listFields = 'labelId=Данни->Етикет, mediaId=Данни->Медия, labelsCnt=Брой->Етикети, copiesCnt=Брой->Копия, printedCnt=Брой->Отпечатвания, tools=✍, createdOn, createdBy, modifiedOn, modifiedBy';
