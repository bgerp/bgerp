...
class log_Setup
{
    ...
    var $configDescription = array(
    	'LOG_EMAIL_RESENDING_TIME' => array ('time(suggestions=1 часа|2 часа|3 часа|5 часа|7 часа|10 часа|12 часа)', 'caption=След колко време имейлът да се счита за изпратен преди да се изпрати повторно->Време'),
        );
