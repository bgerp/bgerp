...
class marketing_Setup extends core_ProtoSetup
{
	...
	var $configDescription = array(
			'MARKETING_INQUIRE_FROM_EMAIL'  => array('key(mvc=email_Inboxes,select=email,allowEmpty)', 'caption=Запитвания->Изходящ имейл за нотификация'),
			'MARKETING_INQUIRE_TO_EMAIL'    => array('emails', 'caption=Запитвания->Имейл за нотифициране'),
	);
