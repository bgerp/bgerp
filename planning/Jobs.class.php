    ...
    protected static function on_AfterRecToVerbal($mvc, &$row, $rec, $fields = array())
    {
        ...
        if (isset($fields['-single'])) {
            ...
            if(is_object($sumAdditionalMeasure)){
                ...
                $row->quantityProduced = "{$row->quantityProduced} <span style='color:darkblue;font-size:15px;font-style:italic;'>({$additionalQuantityVerbal} {$additionalMeasureName}) </span>";
            }
        }
