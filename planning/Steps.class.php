...
class planning_Steps extends core_Extender
{
    ...
    public function description()
    {
        ...
        $this->FLD('wasteProductId', 'key2(mvc=cat_Products,forceReplica,select=name,selectSourceArr=cat_Products::getProductOptions,allowEmpty,maxSuggestions=100,forceAjax)', 'caption=Отпадък в производствена операция->Артикул,silent,class=w100');
