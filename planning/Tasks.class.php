...
class planning_Tasks extends core_Master
{
     ...
     * @see plg_Clone
     */
    public $fieldsNotToClone = 'progress,totalWeight,scrappedQuantity,producedQuantity,totalQuantity,plannedQuantity,timeStart,timeEnd,timeDuration,systemId,orderByAssetId,prevAssetId';
    ...
    protected static function on_AfterPrepareEditForm($mvc, &$data)
    {
        ...
        if(!countR($options)){
            followRetUrl(null, 'В център няма споделени етапи за производство|*!', 'warning');
        } elseif($stepOptionsCount == 1){
            $form->setDefault('productId', key($options));
        } else {
