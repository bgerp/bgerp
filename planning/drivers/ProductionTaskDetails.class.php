    ...
    protected static function on_AfterPrepareListToolbar($mvc, &$data)
    {
    	...
    	if(!empty($data->toolbar->buttons['btnAdd'])){
    		...
    		if($mvc->haveRightFor('add', (object)array('taskId' => $data->masterId, 'type' => 'input'))){
    			$data->toolbar->addBtn('Влагане', array($mvc, 'add', 'taskId' => $data->masterId, 'type' => 'input', 'ret_url' => TRUE), FALSE, 'ef_icon = img/16/wooden-box.png,title=Добавяне на произведен артикул');
    		}
