...
class pos_Points extends core_Master
{
     ...
     */
    public $loadList = 'plg_RowTools2, plg_Settings, plg_Rejected, doc_FolderPlg, doc_plg_Close, pos_Wrapper, plg_Current, plg_State, plg_Created';
    ...
    {
        $data->query->orderBy('state,id', 'ASC');
    }
}
