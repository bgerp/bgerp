    ...
    */
	...
	public function renderPriceList($data)
	{
		...
		if($data->priceLists->addUrl){
			$title .= ht::createLink("<img src=" . sbf('img/16/add.png') . " style='vertical-align: bottom; margin-left:5px;'>", $data->priceLists->addUrl, FALSE, 'title=Добавяне на нова себестойност');
		}
