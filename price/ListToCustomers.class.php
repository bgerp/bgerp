...
class price_ListToCustomers extends core_Detail
{
    ...
    public static function on_AfterRenderDetail($mvc, &$tpl, $data)
    {
        ...
        if ($data->addUrl) {
            $tpl->append(ht::createLink("<img src=" . sbf('img/16/add.png') . " style='vertical-align: bottom; margin-left:5px;'>", $data->addUrl, FALSE, 'title=' . tr('Избор на Ценова политика')), 'title');
        }
    }
