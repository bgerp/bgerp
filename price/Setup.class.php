...
class price_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        'PRICE_STORE_AVERAGE_PRICES' => array('keylist(mvc=store_Stores,select=name)', 'caption=Складове|*&comma;| за които се изчислява "Осреднена за избрани складове" себестойност->Избор,callOnChange=price_interface_AverageCostStorePricePolicyImpl::saveAvgPrices'),
