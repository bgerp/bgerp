...
class price_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        'PRICE_MIN_DECIMALS' => array('int(min=0)', 'caption=Закръгляне за избрания вид (с/без ДДС) цени (стойности 2 и 1 за цена Х.хх)->Десетични знаци', "unit= (|желан брой цифри след десетичната запетая|*)"),
        'PRICE_SIGNIFICANT_DIGITS' => array('int(min=0)', 'caption=Закръгляне за избрания вид (с/без ДДС) цени (стойности 2 и 1 за цена Х.хх)->Значещи цифри', "unit= (|но минимален брой цифри различни от|* 0)"),
