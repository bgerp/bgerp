...
class purchase_InvoiceDetails extends deals_InvoiceDetail
{
     ...
     */
    public $loadList = 'plg_RowTools, plg_Created, plg_Sorting, purchase_Wrapper, plg_RowNumbering, plg_SaveAndNew, plg_AlignDecimals2, doc_plg_HidePrices, deals_plg_DpInvoice,Policy=purchase_PurchaseLastPricePolicy';
