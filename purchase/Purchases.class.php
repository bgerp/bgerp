...
class purchase_Purchases extends deals_DealMaster
{
	...
	*/
    ...
    public $allowedPaymentOperations = array(
    		...
    		'supplier2case'        => array('title' => 'Прехвърляне от Доставчик', 'debit' => '501', 'credit' => '401', 'reverse' => TRUE),
    		'supplier2bank'        => array('title' => 'Прехвърляне от Доставчик', 'debit' => '503', 'credit' => '401', 'reverse' => TRUE),
