...
class rack_ZoneDetails extends core_Detail
{
    ...
    {
        $row->productId = Mode::get('inlineDetail') ? ht::createLinkRef($row->productId, array('cat_Products', 'single', $rec->productId)) : cat_Products::getShortHyperlink($rec->productId, true);
