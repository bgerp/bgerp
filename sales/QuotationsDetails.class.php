...
class sales_QuotationsDetails extends deals_QuotationDetails
{
     ...
     */
    public $loadList = 'plg_RowTools2, sales_Wrapper, doc_plg_HidePrices, cat_plg_LogPackUsage, deals_plg_ImportDealDetailProduct, plg_SaveAndNew, LastPricePolicy=sales_SalesLastPricePolicy, cat_plg_CreateProductFromDocument,plg_PrevAndNext,cat_plg_ShowCodes';
