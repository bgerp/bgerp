...
class sales_SaleRequests extends core_Master
{
    ...
    protected static function on_AfterPrepareSingleToolbar($mvc, &$data)
    {
    	if ($data->rec->state == 'active') {
    		$data->toolbar->addBtn('Продажба', array($mvc, 'createSale', $data->rec->id, 'ret_url' => TRUE), array('warning' => "Сигурнили сте че искате да създадете продажба?", 'order' => "22",'ef_icon' => "img/16/cart_go.png",'title' => "Създаване на нова продажба по заявката"));
    	}
