...
class sales_SalesDetails extends deals_DealDetail
{
    ...
    public $loadList = 'plg_RowTools2, plg_Created, sales_Wrapper, plg_RowNumbering, plg_SaveAndNew, plg_PrevAndNext,
                        plg_AlignDecimals2, plg_Sorting, deals_plg_EditDetailQuantities, cat_plg_LogPackUsage, deals_plg_ImportDealDetailProduct, doc_plg_HidePrices, LastPricePolicy=sales_SalesLastPricePolicy,cat_plg_CreateProductFromDocument,doc_plg_HideMeasureAndQuantityColumns,deals_plg_UpdateCurrencyRates,cat_plg_ShowCodes';
