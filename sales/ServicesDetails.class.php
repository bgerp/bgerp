...
class sales_ServicesDetails extends deals_DeliveryDocumentDetail
{
    ...
    public $loadList = 'plg_RowTools2, plg_Created, sales_Wrapper, plg_RowNumbering, plg_SaveAndNew, 
                        ...
                        ReversePolicy=purchase_PurchaseLastPricePolicy, cat_plg_LogPackUsage,acc_plg_ExpenseAllocation, plg_PrevAndNext,doc_plg_HideMeasureAndQuantityColumns,cat_plg_ShowCodes';
    ...
    public static function on_AfterPrepareListRows(core_Mvc $mvc, $data)
    {
        ...
        if (countR($data->rows)) {
            foreach ($data->rows as $i => &$row) {
                ...
                $row->productId = cat_Products::getAutoProductDesc($rec->productId, $date, $rec->showMode, 'public', $tplLang);
