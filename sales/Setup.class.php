 ...
 */
defIfNot('SALES_DEFAULT_BLAST_BODY_BG',  "Имате просрочия по [#docs#].\nМоля направете плащане.");

/**
 * Дефолтен subject на циркулярен имейл за просрочени фактури
 */
defIfNot('SALES_DEFAULT_BLAST_SUBJECT_BG', "Просрочия към [#date#]");

/**
 * Дефолтен текст на циркулярен имейл за просрочени фактури на английски
 */
defIfNot('SALES_DEFAULT_BLAST_BODY_EN',  "In english : Имате просрочия по [#docs#].\nМоля направете плащане.");

/**
 * Дефолтен subject на циркулярен имейл за просрочени фактури на английски
 */
defIfNot('SALES_DEFAULT_BLAST_SUBJECT_EN', " In english : Просрочия към [#date#]");
