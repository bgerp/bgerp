...
class sales_reports_SalesByContragents extends frame2_driver_TableData
{
    ...
    {
        $fieldset->FLD('compare', 'enum(no=Без, previous=Предходния със същата продължителност,month=По месеци, year=Същия през миналата година)', 'caption=Сравнение с,after=title,refreshForm,single=none,silent');
