...
/**
 * Драйвер за IP сензор Teracom TCW-121 - следи и променя състоянието на реле 1
 */
class sens_driver_TCW121_Relay1 extends sens_driver_IpDevice
{
    /**
    ...
    function getData()
    {
        ...
        $res = array(
            'Реле 1' => $result['/Entry[9]/Value[1]'],
            'st' => $result['/Entry[9]/Value[1]']
        ); 
