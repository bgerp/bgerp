...
/**
 * Драйвер за IP сензор Teracom TCW-121 - Следи и променя състоянието на реле 2
 */
class sens_driver_TCW121_Relay2 extends sens_driver_IpDevice
{
    /**
    ...
    function getData()
    {
        ...
        $res = array(
            'Реле 2' => $result['/Entry[10]/Value[1]'],
            'st' => $result['/Entry[10]/Value[1]']
        ); 
