...
class sens2_DriverIntf
{
     ...
     *
     * @return  array   Масив с ключове - системните имена на входовете и стойности - стрингови списъци
     *                  от препоръчителните им размерни единици или празен стринг, ако такива няма
     */
     ...
     *
     * @return  array   Mасив с ключове - системните имена на изходите и стойности - стрингови списъци
     *                  от препоръчителните им размерни единици или празен стринг, ако такива няма
     */
     ...
     *
     * @param   array   $outputs            масив със системните имена на входовете, които трябва да бъдат прочетени
     * @param   array   $config             конфигурациони параметри
     * @param   array   $persistentState    персистентно състояние на контролера от базата данни
     *
     * @return  mixed                       Mасив със системните имена на изходите и стойностите, които са записани
     *                                      В случайн на грешка, стойността започва с #, последван от текстово описание на проблема
     */
