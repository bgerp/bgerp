...
class social_Followers extends core_Master
{
    ...
    static function getButtons()
    {
		...
		foreach($socialNetworks as $socialNetwork){
			...
			$link = ht::createLink("{$img}" . $socialNetwork->sharedCnt, $url, NULL, array("class" => "soc-following noSelect", "target"=>"_blank", "title" => tr('Последвайте ни в '). $socialNetwork->title));
