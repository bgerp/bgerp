...
class social_Sharings extends core_Master
{
     ...
     * Заглавие
     */
    public $title = 'Бутони за споделяне в социални мрежи';
     ...
     */
    public $listFields = 'name,url,icon,sharedCnt,state,order';
     ...
     *
     */
    public static function getServiceNameByUrl($url)
    {
     ...
     */
    public static function getCanonicUrlPart($url)
    {
