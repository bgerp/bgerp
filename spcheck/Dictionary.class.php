...
class spcheck_Dictionary extends core_Manager
{
     ...
     * [3] => евристика за определяне на имена
     */
    protected static $maskPattern = array("/\<a.+?(<\/a>)/iu", "/[^\p{L}0-9][\p{Lu}0-9]{2,}([^\p{L}0-9])/u", "/[\p{Ll}0-9]{1,}[\p{Lu}]+[\p{L}0-9]*/u", "/([^\S\x0a\x0d]|\,|\:|\;|\-){1}((\p{Lu}+)|(\p{Lu}+\p{L}+))(\p{L})*/u");
