...
class EPSFacade {
   ...
   */
    ...
    */
     ...
     * @throws ClientException Thrown in case EPS interface implementation is not set
     * @throws ServerException Thrown in case communication with server has failed
     * @return array bytes and routing information
     */
    public function createPDFEx($params) {
        $this->checkStateBeforeCall();
        return $this->_epsInterfaceImpl->createPDFEx($this->getResultLogin(true)->getSessionId(), $params);
    }   
