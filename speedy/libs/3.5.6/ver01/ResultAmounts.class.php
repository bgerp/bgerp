...
class ResultAmounts {
     ...
     * @since 3.5.6
     */
    private $_additionalDeliverySurcharge;
    ...
    function __construct($stdClassResultAmounts) {
        ...
        $this->_additionalDeliverySurcharge = isset($stdClassResultAmounts->additionalDeliverySurcharge) ? $stdClassResultAmounts->additionalDeliverySurcharge : null;
    }
    ...
    /**
     * Set additional delivery surcharge
     * @param signed 64-bit real
     */
    public function setAdditionalDeliverySurcharge($additionalDeliverySurcharge) {
        $this->_additionalDeliverySurcharge = $additionalDeliverySurcharge;
    }

    /**
     * Get additional delivery surcharge
     * @return signed 64-bit real
     */
    public function getAdditionalDeliverySurcharge() {
        return $this->_additionalDeliverySurcharge;
    } 
