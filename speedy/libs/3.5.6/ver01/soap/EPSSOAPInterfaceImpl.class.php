...
class EPSSOAPInterfaceImpl extends SoapClient implements EPSInterface {
    ...
    */
    ...
    /**
     * @see EPSInterface::createPDFEx()
     */
    public function createPDFEx($sessionId, $params) {
        try {
            $createPDFExStdObject = new stdClass();
            $createPDFExStdObject->sessionId = $sessionId;
            $createPDFExStdObject->params = $params->toStdClass();
            $response = parent::createPDFEx($createPDFExStdObject);
           
            if (isset($response->return)) {
                $CreatePDFExResponse = new CreatePDFExResponse($response->return);
            } else {
                $CreatePDFExResponse = null;
            }
            return $CreatePDFExResponse;
