    ...
    protected static function on_AfterRecToVerbal($mvc, &$row, $rec, $fields = array())
    {
        ...
        if (isset($fields['-single'])) {
            ...
            if ($rec->locationId) {
                ...
                foreach (array('address' => 'deliveryAddress', 'company' => 'deliveryCompany', 'person' => 'deliveryPerson', 'tel' => 'deliveryTel', 'pCode' => 'deliverypCode', 'place' => 'deliveryPlace', 'features' => 'features', 'addressInfo' => 'addressInfo') as $recFld => $recPlaceholder){
                    if (!empty($rec->{$recFld})) {
                        if($recFld == 'features'){
