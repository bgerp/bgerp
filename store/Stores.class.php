...
class store_Stores extends core_Master
{
    ...
    public function description()
    {
        ...
        $this->FLD('samePosPallets', 'enum(,no=Не,yes=Да)', 'caption=Различни палети на една позиция->Разрешаване,maxRadio=3,placeholder=Автоматично');
        ...
        $this->FLD('prioritizeRackGroups', 'enum(,yes=Да,no=Не)', 'caption=Използване на приоритетни стелажи->Разрешаване,maxRadio=3,placeholder=Автоматично');
