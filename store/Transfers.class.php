...
class store_Transfers extends core_Master
{
    ...
    protected static function on_AfterRecToVerbal($mvc, &$row, $rec, $fields = array())
    {
        ...
        } elseif (!isset($rec->storeReadiness)) {
            $row->storeReadiness = "<b class='quiet'>N/A</b>";
        }
    ...
    public function getShipmentDateFields($rec = null, $cache = false)
    {
        ...
        if(isset($rec)){
            $res['deliveryTime']['placeholder'] = store_Stores::calcLoadingDate($rec->fromStore, $rec->deliveryOn ?? null);
