...
class store_reports_ReportConsignmentProtocols extends frame2_driver_TableData
{
    ...
    protected function detailRecToVerbal($rec, &$dRec)
    {
        ...
        $row->contragent = "<span style='line-height: 170%'>" . doc_Folders::getTitleById($dRec->contragent) . "</span>";
        ...
        $row->contragent .= "<span class='fright'>" . ht::createBtn('Нов ПОП', $cUrl, false, false, "ef_icon = img/16/add.png") . "</span>";
