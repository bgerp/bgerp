...
class tags_Tags extends core_Manager
{
    ...
    public function description()
    {
        ...
        $this->FLD('classes', 'classes(interface=doc_DocumentIntf,select=title,allowEmpty)', 'caption=Документи');
    ...
    {
        $data->listFilter->FLD('tagId', 'key(mvc=tags_Tags, select=name, allowEmpty)', 'caption=Таг,placeholderType=all, refreshForm');
