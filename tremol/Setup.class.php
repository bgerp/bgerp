 ...
 */
defIfNot('TREMOL_FP_DRIVER_VERSION', '11.01');
...
class tremol_Setup extends core_ProtoSetup
{
    ...
    public $configDescription = array(
        ...
        'TREMOL_FP_DRIVER_VERSION' => array('enum(11.01)', 'caption=Тремол->Версия на драйверите на ФУ, customizeBy=peripheral|admin'),
    );
