...
class FP extends FP_Core {
   ...
   */
  public function ReadReceiptNumQRcodeData($RcpNum) {
    return $this->execute("ReadReceiptNumQRcodeData", "RcpNum", $RcpNum);
  }
   ...
   * @param double $RcpNum 6 symbols with format ######
   */
  public function ReadElectronicReceiptDataFromEJ($RcpNum) {
    $this->execute("ReadElectronicReceiptDataFromEJ", "RcpNum", $RcpNum);
  }
