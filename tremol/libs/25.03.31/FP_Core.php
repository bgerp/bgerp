...
namespace Tremol {
    ...
    class SException extends Exception {
        protected $ste1 = NULL;
        protected $ste2 = NULL;
		protected $fpliberror = NULL;
        protected $is_fp_exception = FALSE;
        
        function __construct($message, $code, $previous = NULL, $in_ste1 = NULL, $in_ste2 = NULL, $in_fpliberror = NULL) {
			...
			if($in_fpliberror !== NULL) {
                $this->fpliberror = $in_fpliberror;
            }
        }
    ...
    class FP_Core {
         ...
         */
		public function ServerSetCustomClientId($clientId){
        ...
        private function throwOnServerError($resp) {
            ...
            if ($resCode !== 0) {
                ...
                if($resCode == 40) {
					...
					$liberror = hexdec($errNode->attributes()->FPLibErrorCode);
                    throw new SException($errMsg, $resCode, NULL, $ste1, $ste2, $liberror);
                }
                else {
