...
Tremol.FP.prototype.timeStamp = 2503311400;
/**
 ...
 * @param {Tremol.Enums.OptionParRetract} OptionParRetract 1 symbol with value: 
 ...
 */
Tremol.FP.prototype.CloseNonFiscReceiptRetract = function (OptionParRetract, TimeoutReceiptRetract) {
	return this.do('CloseNonFiscReceiptRetract', 'OptionParRetract', OptionParRetract, 'TimeoutReceiptRetract', TimeoutReceiptRetract);
};

/**
 * Paying the exact amount in cash and closes the fiscal receipt with definition of retract parameter and retract timeout.
 * @param {Tremol.Enums.OptionParRetract1} OptionParRetract1 1 symbol with value: 
...
If '0' the timeout is default, if '255' the timeout is infinite
 */
Tremol.FP.prototype.CashPayCloseReceiptRetract = function (OptionParRetract1, TimeoutReceiptRetract) {
	return this.do('CashPayCloseReceiptRetract', 'OptionParRetract', OptionParRetract1, 'TimeoutReceiptRetract', TimeoutReceiptRetract);
};
...
* YYYYYYY - 7 symbols [0-9] for next number of the receipt
 */
Tremol.FP.prototype.OpenStornoElectronicReceipt = function (OperNum, OperPass, OptionReceiptFormat, OptionPrintVAT, OptionStornoReason, RelatedToRcpNum, RelatedToRcpDateTime, FMNum, RelatedToURN) {
	return this.do('OpenStornoElectronicReceipt', 'OperNum', OperNum, 'OperPass', OperPass, 'OptionReceiptFormat', OptionReceiptFormat, 'OptionPrintVAT', OptionPrintVAT, 'OptionStornoReason', OptionStornoReason, 'RelatedToRcpNum', RelatedToRcpNum, 'RelatedToRcpDateTime', RelatedToRcpDateTime, 'FMNum', FMNum, 'RelatedToURN', RelatedToURN);
};
...
If '0' the timeout is default, if '255' the timeout is infinite
 */
Tremol.FP.prototype.CancelReceiptRetract = function (OptionParRetract1, TimeoutReceiptRetract) {
	return this.do('CancelReceiptRetract', 'OptionParRetract', OptionParRetract1, 'TimeoutReceiptRetract', TimeoutReceiptRetract);
};
 ...
 * @property {boolean} Blocked_device_due_to_unsent_receipts_to_NRA Blocked device due to unsent receipts to NRA
 */
 ...
 */
Tremol.FP.prototype.GenerateElectronicDuplicate = function () {
	return this.do('GenerateElectronicDuplicate');
};
...
If '0' the timeout is default, if '255' the timeout is infinite
 */
Tremol.FP.prototype.CloseReceiptRetract = function (OptionParRetract1, TimeoutReceiptRetract) {
	return this.do('CloseReceiptRetract', 'OptionParRetract', OptionParRetract1, 'TimeoutReceiptRetract', TimeoutReceiptRetract);
};
...
Tremol.Enums = Tremol.Enums || {
	...
	/**
	 * @typedef {Tremol.Enums.OptionParRetract} Tremol.Enums.OptionParRetract
	 * @readonly
	 * @enum
	 */
	OptionParRetract: {
		bon_goes_into_machine: '0',
		bon_goes_out_and_returns_after_timeout: '1'
	},
	
	/**
	 * @typedef {Tremol.Enums.OptionParRetract1} Tremol.Enums.OptionParRetract1
	 * @readonly
	 * @enum
	 */
	OptionParRetract1: {
		bon_goes_into_machine: '2',
		bon_goes_out_and_returns_after_default_timeout: '0',
		bon_goes_out_and_returns_after_timeout: '1'
	},
