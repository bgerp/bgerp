...
namespace Tremol {
  ...
  class OptionParRetract extends EnumType {
    const bon_goes_into_machine = '0';
    const bon_goes_out_and_returns_after_timeout = '1';
  }
  
  class OptionParRetract1 extends EnumType {
    const bon_goes_into_machine = '2';
    const bon_goes_out_and_returns_after_default_timeout = '0';
    const bon_goes_out_and_returns_after_timeout = '1';
  }
...
class StatusRes extends BaseResClass {
  ...
  protected $Blocked_device_due_to_unsent_receipts_to_NRA;
}
...
class FP extends FP_Core {
  ...
  /**
   * Closes the non-fiscal receipt with definition of retract parameter and retract timeout.
   * @param OptionParRetract $OptionParRetract 1 symbol with value: 
   * - '0' - bon goes into machine 
   * - '1' - bon goes out and returns after timeout
   * @param string $TimeoutReceiptRetract Up to 3 symbols with value from 0 to 255 for timeout in sec. 
   * If '0' the timeout is default, if '255' the timeout is infinite
   */
  public function CloseNonFiscReceiptRetract($OptionParRetract,$TimeoutReceiptRetract) {
    $this->execute("CloseNonFiscReceiptRetract", "OptionParRetract", $OptionParRetract, "TimeoutReceiptRetract", $TimeoutReceiptRetract);
  }
  
  /**
   * Paying the exact amount in cash and closes the fiscal receipt with definition of retract parameter and retract timeout.
   * @param OptionParRetract1 $OptionParRetract1 1 symbol with value: 
   * - '0' - bon goes out and returns after default timeout 
   * - '1' - bon goes out and returns after timeout  
   * - '2' - bon goes into machine
   * @param string $TimeoutReceiptRetract Up to 3 symbols with value from 0 to 255 for timeout in sec. 
   * If '0' the timeout is default, if '255' the timeout is infinite
   */
  public function CashPayCloseReceiptRetract($OptionParRetract1,$TimeoutReceiptRetract) {
    $this->execute("CashPayCloseReceiptRetract", "OptionParRetract", $OptionParRetract1, "TimeoutReceiptRetract", $TimeoutReceiptRetract);
  }
   ...
   * * YYYYYYY - 7 symbols [0-9] for next number of the receipt
   */
  public function OpenStornoElectronicReceipt($OperNum,$OperPass,$OptionReceiptFormat,$OptionPrintVAT,$OptionStornoReason,$RelatedToRcpNum,$RelatedToRcpDateTime,$FMNum,$RelatedToURN=NULL) {
    $this->execute("OpenStornoElectronicReceipt", "OperNum", $OperNum, "OperPass", $OperPass, "OptionReceiptFormat", $OptionReceiptFormat, "OptionPrintVAT", $OptionPrintVAT, "OptionStornoReason", $OptionStornoReason, "RelatedToRcpNum", $RelatedToRcpNum, "RelatedToRcpDateTime", $RelatedToRcpDateTime, "FMNum", $FMNum, "RelatedToURN", $RelatedToURN);
  }
  
  /**
   * Cancel the fiscal receipt with definition of retract parameter and retract timeout.
   * @param OptionParRetract1 $OptionParRetract1 1 symbol with value: 
   * - '0' - bon goes out and returns after default timeout 
   * - '1' - bon goes out and returns after timeout  
   * - '2' - bon goes into machine
   ...
   * If '0' the timeout is default, if '255' the timeout is infinite
   */
  public function CancelReceiptRetract($OptionParRetract1,$TimeoutReceiptRetract) {
    $this->execute("CancelReceiptRetract", "OptionParRetract", $OptionParRetract1, "TimeoutReceiptRetract", $TimeoutReceiptRetract);
  }
   ...
   */
  public function ProgExtDisplay($Password) {
    $this->execute("ProgExtDisplay", "Password", $Password);
  }
  ...
  /**
   * Generate electronic duplicate of last receipt issued. When FD parameter for duplicates is enabled.
   */
  public function GenerateElectronicDuplicate() {
    $this->execute("GenerateElectronicDuplicate");
  }
  ...
  /**
   * Closes the fiscal receipt with definition of retract parameter and retract timeout.
   * @param OptionParRetract1 $OptionParRetract1 1 symbol with value: 
   * - '0' - bon goes out and returns after default timeout 
   * - '1' - bon goes out and returns after timeout  
   * - '2' - bon goes into machine
   ...
   * If '0' the timeout is default, if '255' the timeout is infinite
   */
  public function CloseReceiptRetract($OptionParRetract1,$TimeoutReceiptRetract) {
    $this->execute("CloseReceiptRetract", "OptionParRetract", $OptionParRetract1, "TimeoutReceiptRetract", $TimeoutReceiptRetract);
  }
